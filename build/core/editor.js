...
class Editor {
            ...
            if (op.insert != null) {
                ...
                if (typeof op.insert === 'string') {
                    ...
                    if (isInlineEmbed) {
                        ...
                        else if (leaf instanceof EmbedBlot &&
    ...
    getFormat(index, length = 0) {
        ...
        return Object.assign(Object.assign({}, lineFormats), leafFormats);
    }
    ...
    isBlank() {
        ...
        if ((blot === null || blot === void 0 ? void 0 : blot.statics.blotName) !== Block.blotName)
            return false;
        const block = blot;
...
function convertHTML(blot, index, length, excludeOuterTag = false) {
    ...
    if (blot instanceof ParentBlot) {
        ...
        if (blot.statics.blotName === 'list-container') {
            ...
            blot.children.forEachAt(index, length, (child, offset, childLength) => {
                const formats = 'formats' in child && typeof child.formats === 'function'
                    ? child.formats()
                    : {};
                items.push({
                    child,
