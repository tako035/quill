...
class Clipboard extends Module {
    ...
    onCapturePaste(e) {
        ...
        const files = Array.from(((_c = e.clipboardData) === null || _c === void 0 ? void 0 : _c.files) || []);
        ...
        if (html && files.length > 0) {
            ...
            if (doc.body.childElementCount === 1 &&
                ((_d = doc.body.firstElementChild) === null || _d === void 0 ? void 0 : _d.tagName) === 'IMG') {
                this.quill.uploader.upload(range, files);
                return;
            }
        }
                ...
                default:
                    Array.from(container.querySelectorAll(selector)).forEach((node) => {
                        if (nodeMatches.has(node)) {
                            ...
                            matches === null || matches === void 0 ? void 0 : matches.push(matcher);
                        }
                        else {
...
function matchStyles(node, delta) {
    ...
    if (((_a = style.fontWeight) === null || _a === void 0 ? void 0 : _a.startsWith('bold')) ||
        // @ts-expect-error Fix me later
...
function matchTable(node, delta) {
    var _a, _b;
    const table = ((_a = node.parentElement) === null || _a === void 0 ? void 0 : _a.tagName) === 'TABLE'
        ? node.parentElement
        : (_b = node.parentElement) === null || _b === void 0 ? void 0 : _b.parentElement;
    if (table != null) {
...
function matchText(node, delta) {
    ...
    if (((_a = node.parentElement) === null || _a === void 0 ? void 0 : _a.tagName) === 'O:P') {
